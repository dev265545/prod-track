      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex min-h-svh w-full has-[[data-variant=inset]]:bg-sidebar sidebar-transition",
              className
            )}
            ref={ref}
            {...props}
    ...
    return (
      <div
        ...
        className={cn(
          ...
          "w-[var(--sidebar-width)] transition-[width] duration-250 ease-[var(--ease-out-quart)]",
      ...
      >
        <div
          className={cn(
            "relative h-svh w-[--sidebar-width] bg-transparent transition-[width] duration-250 ease-[var(--ease-out-quart)]",
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] duration-[250ms] ease-[var(--ease-out-quart)] md:flex",
            side === "left"
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      aria-label={showExpandIcon ? "Open sidebar" : "Collapse sidebar"}
      title={showExpandIcon ? "Open sidebar" : "Collapse sidebar"}
      {...props}
    >
      {showExpandIcon ? (
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all duration-[250ms] ease-[var(--ease-out-quart)] after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] group-data-[side=left]:-right-4 group-data-[side=right]:left-0 hover:after:bg-sidebar-border sm:flex",
  ...
  "peer/menu-button flex w-full items-center gap-3 overflow-hidden rounded-lg px-3 py-2.5 text-left text-sm font-semibold outline-none ring-sidebar-ring transition-[width,height,padding,colors] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-active data-[active=true]:font-bold data-[active=true]:text-white data-[active=true]:border-l-4 data-[active=true]:border-sidebar-primary data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-10 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-5 [&>svg]:shrink-0",
  {
    variants: {
      ...
      size: {
        ...
        sm: "h-9 text-xs",
        lg: "h-14 text-base group-data-[collapsible=icon]:!size-12 group-data-[collapsible=icon]:!p-2.5",
      },
    },
    defaultVariants: {
      variant: "default",
